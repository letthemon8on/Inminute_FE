...
// import { IScriptItem } from "../../context/AppContext";
...
// const ScriptItem: React.FC<ScriptItemProps> = ({ noteId, item }) => {
//   const { updateScriptItem, deleteScriptItem } = useAppContext();
...
//     if (newContent.trim()) {
//       updateScriptItem(noteId, item.id, newContent.trim());
//       setIsEditing(false);
//     }
//   };
...
//   const handleDelete = () => {
//     deleteScriptItem(noteId, item.id);
//   };
